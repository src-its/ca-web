...
A web server is an information technology that processes requests via HTTP. HTTP is the basic network protocol used to distribute information on the World Wide Web.[1]
