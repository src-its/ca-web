...
<!-- I think it's fine if we just replace these with a description of the warning as below
...
You may be warned that the authenticity of github's identity cannot be established. 
Verify that the fingerprint in the message you see matches the following message, then type yes:
<!-- which following message? -->
```
